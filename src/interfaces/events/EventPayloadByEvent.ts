...
export type EventPayloadByEvent = {
  ...
  [Event.RemotePlay]: RemoteHandledEvent;
  [Event.RemotePlayId]: RemotePlayIdEvent;
  [Event.RemotePlaySearch]: RemotePlaySearchEvent;
  [Event.RemotePause]: RemoteHandledEvent;
  [Event.RemoteStop]: RemoteHandledEvent;
  [Event.RemoteSkip]: RemoteSkipEvent;
  [Event.RemoteNext]: RemoteHandledEvent;
  [Event.RemotePrevious]: RemoteHandledEvent;
